...
public class ListViewFragmentRecyclerViewItemViewState {
    ...
    public ListViewFragmentRecyclerViewItemViewState(String name, String vicinity, Boolean isOpen, float rating, String photoReference, String placeId, String distanceFromUserLocation) {
        this.name = name;
